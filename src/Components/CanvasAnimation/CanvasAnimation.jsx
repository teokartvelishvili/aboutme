...
const CanvasAnimation = () => {
  ...
  useEffect(() => {
    ...
    class App {
      ...
      createRopes() {
        ...
        for (let i = 0; i < TOTAL + 1; i++) {
          const x = this.randomNumBetween(App.width * 0.3, App.width * 0.7);
          const y = 0;
          const gap = this.randomNumBetween(App.height * 0.05, App.height * 0.08);
          const segments = 10;
    ...
    const app = new App(canvas, lightImage);
    app.render();
